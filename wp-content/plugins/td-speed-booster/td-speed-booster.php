    ...
    function render_footer_styles() {
        ...
        foreach ($this->style_footer_queue as $style_id => $wp_dependency_object) {
	        if (strrpos($wp_dependency_object->src, '?') === false) {
		        echo "<link rel='stylesheet' id='" . $style_id . "-css'  href='" . $wp_dependency_object->src . "?ver=" . $current_theme_version . "' type='text/css' media='" . $wp_dependency_object->args . "' />\n";
	        } else {
		        echo "<link rel='stylesheet' id='" . $style_id . "-css'  href='" . $wp_dependency_object->src . "&ver=" . $current_theme_version . "' type='text/css' media='" . $wp_dependency_object->args . "' />\n";
	        }
